...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        ...
        var expected1 = Map.of();
        assertThat(result1).isEqualTo(expected1);

        Address address2 = new Address("Rs", "London", "1-st street", "5", "1");
        var result2 = Validator.advancedValidate(address2);
        var expected2 = Map.of("country", List.of("length less than 4"));
        assertThat(result2).isEqualTo(expected2);

        Address address3 = new Address("Rs", "London", null, "5", "1");
